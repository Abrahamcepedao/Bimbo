    ...
    return (
        <div className="py-8 px-4">
            <div className="max-w-2xl m-auto text-justify">
                ...
                <h3 className="bold text-white_primary">Índice de Sostenibilidad</h3>
                ...
                <h3 className="bold text-white_primary">Índice de Congruencia</h3>
                ...
                <h3 className="bold text-white_primary">Índice de Bien Común</h3>
